 ...
 class CreateEmployee extends Component {
    ...
    changeDesginHandler=(event)=>{
       ...
       if(event.target.value=='EMPLOYEE'){
        this.setState({state_pm:false})          
    }
    else{
        this.setState({state_pm:true})
        this.setState({pm:""})
    }
    }
        ...
        return (
          ...
          <div>
               ...
               <div className="main-content">
                <div className="del">
        <form name="myform" className="form-group" onSubmit={this.handleSubmit}>
        
            <h2 style={{'textAlign':'center', 'fontweight': 'bold', 'fontsize': '45px'}}>ADD NEW MEMBER</h2>
            <div className="row jumbotron">
                <div className="col-md-6">
                    <label for="inputname">First name</label>
                    <input required placeholder="First Name" name="firstName" className="form-control" value={this.state.firstName} onChange={this.changeFirstNameHandler} />
                    <div style={{color:"red"}} >{this.state.Fnamerror}</div>
                </div>
                <div className="col-md-6">
                ...
                <label for="inputname">State</label>
                    <select value={this.state.statett} id="sts" name="stt" class="form-control" required onChange={this.changeStateHandler}>
                ...
                <label for="inputname">Gender</label>
                 ...
                 <div className="col-md-4">
                    ...
                    <select hidden={this.state.state_pm} className="form-control" value={this.state.pm} onChange={this.changePMHandler}>
                    <option value=" ">Select Project Manager</option>    {
                               this.state.emp.map(
                                       (employee) =>
                                       employee.design==="PROJECT MANAGER" ?(
                                       
                        <option key={employee.id} value={employee.firstName+employee.lastName}>{employee.firstName+employee.lastName}</option>):null)}
                    </select>
                </div>
                <div className="col-md-4" >
