        ...
        <form name="myform" className="form-group">
            ...
            <div className="row jumbotron">
                ...
                <label for="inputname">Gender</label>
                 ...
                 <div className="card col-md-4 offset-md-4 row jumbotron">
                    <label for="inputname">Regular</label>

                    <select id="Regular" className="form-control"value={this.state.regular} onChange={this.changeRegularHandler}
                   >
                 ...
                 <div className="col-md-4" hidden>
                    ...
                    <select id="PM" className="form-control" value={this.state.pm} onChange={this.changePMHandler}>
